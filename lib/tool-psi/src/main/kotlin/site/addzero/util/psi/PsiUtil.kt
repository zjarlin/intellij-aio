package site.addzero.util.psi

import site.addzero.util.entity.JavaFieldMetaInfo
import site.addzero.util.lsi.impl.psi.isDbField
import site.addzero.util.lsi.impl.psi.toLsiField
import site.addzero.util.lsi.impl.kt.isDbField as ktIsDbField
import site.addzero.util.lsi.impl.kt.toLsiField as ktToLsiField
import site.addzero.util.psi.PsiTypeUtil.isCollectionType
...
object PsiUtil {
    ...
    @Deprecated(
        ...
        ReplaceWith("lsiField.fieldComment", "site.addzero.util.lsi.toLsiField")
    )
    ...
    @Deprecated(
        ...
        ReplaceWith("this.toLsiField().fieldComment", "site.addzero.util.lsi.toLsiField")
    )
...
//            """.trimIndent()).ask("","")
    ...
    @Deprecated(
        ...
        ReplaceWith("this.toLsiClass().guessTableEnglishName", "site.addzero.util.lsi.toLsiClass")
    )
...
//            DialogUtil.showWarningMsg("暂不支持的PsiClass类型$name,隐式转为String")
    ...
    @Deprecated(
        ...
        ReplaceWith("this.toLsiMethod().fieldComment", "site.addzero.util.lsi.toLsiMethod")
    )
    ...
    @Deprecated(
        ...
        ReplaceWith("Pair(psiClass.toLsiClass().fieldComment, psiClass.toLsiClass().guessTableEnglishName)", "site.addzero.util.lsi.toLsiClass")
    )
