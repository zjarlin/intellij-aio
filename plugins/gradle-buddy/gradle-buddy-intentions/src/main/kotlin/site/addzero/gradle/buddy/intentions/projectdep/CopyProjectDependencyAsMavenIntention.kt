...
class CopyProjectDependencyAsMavenIntention : IntentionAction, PriorityAction {
    ...
    override fun getText(): String = GradleBuddyBundle.message("intention.copy.project.dependency.as.maven")

    override fun startInWriteAction(): Boolean = false

    override fun generatePreview(project: Project, editor: Editor, file: PsiFile): IntentionPreviewInfo {
        return IntentionPreviewInfo.Html(
            GradleBuddyBundle.message("intention.copy.project.dependency.as.maven.preview")
        )
    }
    ...
    override fun isAvailable(project: Project, editor: Editor?, file: PsiFile): Boolean {
        ...
        return CopyProjectDependencyAsMavenSupport.findTarget(project, file, editor.caretModel.offset) != null
    }
