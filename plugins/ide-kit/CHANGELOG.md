...
- Added a Kotlin inspection quick fix to move a top-level private function into the current file.
- Added a Kotlin project action and intention to shorten fully qualified names across project files.
