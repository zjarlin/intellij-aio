...
dependencies {
    ...
    implementation(project(":plugins:intellij-kit:smart-intentions-find-source-only"))
    implementation(project(":plugins:intellij-kit:smart-intentions-kotlin-redundant-explicit-type"))
}
