...
class StateMapperIntention : PsiElementBaseIntentionAction(), DumbAware {
    override fun getFamilyName(): String = ComposeBuddyBundle.message("plugin.name")

    override fun getText(): String = ComposeBuddyBundle.message("intention.extract.state.mapper")
    ...
    override fun isAvailable(project: Project, editor: Editor?, element: PsiElement): Boolean {
        ...
        return StateMapperAnalysis.analyze(function, currentEditor) != null
    }

    override fun invoke(project: Project, editor: Editor?, element: PsiElement) {
        val currentEditor = editor ?: return
        val function = element.getStrictParentOfType<KtNamedFunction>() ?: return
        val analysis = StateMapperAnalysis.analyze(function, currentEditor) ?: return
        StateMapperRefactor(project).apply(analysis)
    }
}
