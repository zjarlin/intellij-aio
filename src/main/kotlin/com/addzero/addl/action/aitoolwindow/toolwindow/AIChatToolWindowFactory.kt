...
//                instance ?: run {
//                    val toolWindow = ToolWindowManager.getInstance(project).getToolWindow("AI Chat") ?: throw IllegalStateException("AI Chat tool window not found")
//
//                    // 确保工具窗口是展开的
...
//                    }
//
//                    AIChatToolWindow(project, toolWindow).also { instance = it }
//                }
//            }
//        }
//    }
