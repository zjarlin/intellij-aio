...
, BaseFastExcelApi<${classname}, ${classname}Spec, ${classname}ExcelDTO> {
    ...
    private fun generateControllerCode(ddlContext: DDLContext): String {
        ...
        return """
            package com.addzero.web.modules.second_brain.$entityNameLower
            ...
            import com.addzero.common.kt_util.isNotNew
            import com.addzero.web.infra.upload.DownloadUtil
            import com.addzero.web.modules.second_brain.$entityNameLower.dto.${entityName}SaveDTO
            import com.addzero.web.modules.second_brain.$entityNameLower.dto.${entityName}Spec
            import com.addzero.web.modules.second_brain.$entityNameLower.dto.${entityName}UpdateDTO
            import com.addzero.web.modules.second_brain.$entityNameLower.dto.${entityName}View
            import io.swagger.v3.oas.annotations.Operation
            import org.babyfish.jimmer.Page
            import org.babyfish.jimmer.sql.ast.mutation.AffectedTable
            import org.babyfish.jimmer.sql.kt.KSqlClient
