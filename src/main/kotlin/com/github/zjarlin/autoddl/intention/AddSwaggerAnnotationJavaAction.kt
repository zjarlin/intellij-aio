...
class AddSwaggerAnnotationJavaAction : IntentionAction {
    ...
    override fun invoke(project: Project, editor: Editor?, file: PsiFile?) {
        ...
        for (field in psiClass.fields) {
            processField(project, field)
        }
    }

    private fun processField(project: Project, field: PsiField) {
        // 检查是否已有Swagger注解
        ...
        if (!hasSwaggerAnnotation) {
            ...
            if (docComment != null) {
                addSwaggerAnnotation(project, field, docComment)
            }
        }
    }


    fun addSwaggerAnnotation( project: Project,  field: PsiField,  docComment: PsiDocComment) {
        // 清理文档注释
